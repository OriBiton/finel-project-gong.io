...
def detect_problem_type(target_column):
    ...
    # בדוק אם הערכים הם סדרתיים (ordinal), אם הערכים הם כמו "1", "2", "3", "4" שהם מדד סדר
    elif num_unique <= 6 and target_column.dtype == 'object':
        # אם יש מספר קטן של ערכים, והם יכולים להיות סדרתיים
        return "ordinal"
    
    # אם יש יותר מ-10 ערכים ייחודיים, נניח שמדובר בבעיה של רגרסיה
    elif num_unique > 10:
        return "regression"
